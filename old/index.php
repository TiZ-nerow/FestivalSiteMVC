...
<table width='80%' cellspacing='0' cellpadding='0' align='center'>
   ...
   <tr>
      <td class='texteAccueil'>
      <ul>
         <li>Gérer les établissements (caractéristiques et capacités d'accueil) acceptant d'héberger les groupes de sport.
         <p>
	      </p>
         <li>Consulter, réaliser ou modifier les attributions des chambres aux groupes dans les établissements.
         <p>
         </p>
         <li>Consulter ou modifier les attributions des stands des groupes.
      </ul>
      </td>
   </tr>
</table>";
